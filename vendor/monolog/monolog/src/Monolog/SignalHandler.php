...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \Mailster\Psr\Log\LogLevel::CRITICAL, bool $callPrevious = \true, bool $restartSyscalls = \true, ?bool $async = \true) : self
    {
    ...
    public function handleSignal($signo, array $siginfo = null) : void
    {
        ...
        $level = $this->signalLevelMap[$signo] ?? \Mailster\Psr\Log\LogLevel::CRITICAL;
