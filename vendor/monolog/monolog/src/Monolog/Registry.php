...
class Registry
{
     ...
     */
    public static function addLogger(\Mailster\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \Mailster\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \Mailster\Monolog\Logger
    {
