 ...
 */
abstract class AbstractSyslogHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    protected $facility;
    /**
     * Translates Monolog log levels to syslog log priorities.
     */
    protected $logLevels = [\Mailster\Monolog\Logger::DEBUG => \LOG_DEBUG, \Mailster\Monolog\Logger::INFO => \LOG_INFO, \Mailster\Monolog\Logger::NOTICE => \LOG_NOTICE, \Mailster\Monolog\Logger::WARNING => \LOG_WARNING, \Mailster\Monolog\Logger::ERROR => \LOG_ERR, \Mailster\Monolog\Logger::CRITICAL => \LOG_CRIT, \Mailster\Monolog\Logger::ALERT => \LOG_ALERT, \Mailster\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \Mailster\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
