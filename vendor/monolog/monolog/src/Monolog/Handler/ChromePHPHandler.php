...
use Mailster\Monolog\Formatter\ChromePHPFormatter;
 ...
 */
class ChromePHPHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \Mailster\Monolog\Formatter\ChromePHPFormatter();
    }
    /**
    ...
    protected function send() : void
    {
        ...
        $json = \Mailster\Monolog\Utils::jsonEncode(self::$json, null, \true);
        $data = \base64_encode(\utf8_encode($json));
        if (\strlen($data) > 3 * 1024) {
            self::$overflowed = \true;
            $record = ['message' => 'Incomplete logs, chrome header size limit reached', 'context' => [], 'level' => \Mailster\Monolog\Logger::WARNING, 'level_name' => \Mailster\Monolog\Logger::getLevelName(\Mailster\Monolog\Logger::WARNING), 'channel' => 'monolog', 'datetime' => new \DateTimeImmutable(), 'extra' => []];
