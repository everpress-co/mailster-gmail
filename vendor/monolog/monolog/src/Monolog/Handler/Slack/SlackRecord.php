 ...
 */
namespace Mailster\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \Mailster\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \Mailster\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \Mailster\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \Mailster\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \Mailster\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \Mailster\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \Mailster\Monolog\Utils::DEFAULT_JSON_FLAGS) : \Mailster\Monolog\Utils::jsonEncode($normalized, \Mailster\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\Mailster\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
