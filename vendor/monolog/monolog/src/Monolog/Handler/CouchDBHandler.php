 ...
 */
class CouchDBHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = [], $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
