 ...
 */
class ErrorLogHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(int $messageType = self::OPERATING_SYSTEM, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true, bool $expandNewlines = \false)
    {
    ...
    {
        return new \Mailster\Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message% %context% %extra%');
    }
    /**
     * {@inheritdoc}
     */
