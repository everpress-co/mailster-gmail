 ...
 */
class TelegramBotHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @inheritDoc
     */
    public function __construct(string $apiKey, string $channel, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true, string $parseMode = null, bool $disableWebPagePreview = null, bool $disableNotification = null)
    {
    ...
    protected function send(string $message) : void
    {
        ...
        $result = \Mailster\Monolog\Handler\Curl\Util::execute($ch);
