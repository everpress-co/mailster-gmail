 ...
 */
class SocketHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $connectionString, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
