...
use Mailster\Aws\Sqs\SqsClient;
 ...
 */
class SqsHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    ...
    /** @var string */
    private $queueUrl;
    public function __construct(\Mailster\Aws\Sqs\SqsClient $sqsClient, string $queueUrl, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if (\strlen($messageBody) >= static::MAX_MESSAGE_SIZE) {
            $messageBody = \Mailster\Monolog\Utils::substr($messageBody, 0, static::HEAD_MESSAGE_SIZE);
        }
