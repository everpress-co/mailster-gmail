 ...
 */
class TestHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\Mailster\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \Mailster\Monolog\Logger::toMonologLevel($level);
