...
use Mailster\Monolog\Handler\SyslogUdp\UdpSocket;
/**
 ...
 */
class SyslogUdpHandler extends \Mailster\Monolog\Handler\AbstractSyslogHandler
{
    const RFC3164 = 0;
    const RFC5424 = 1;
     ...
     */
    public function __construct(string $host, int $port = 514, $facility = \LOG_USER, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true, string $ident = 'php', int $rfc = self::RFC5424)
    {
        parent::__construct($facility, $level, $bubble);
        $this->ident = $ident;
        $this->rfc = $rfc;
        $this->socket = new \Mailster\Monolog\Handler\SyslogUdp\UdpSocket($host, $port ?: 514);
    }
     ...
     */
    public function setSocket(\Mailster\Monolog\Handler\SyslogUdp\UdpSocket $socket) : self
    {
        $this->socket = $socket;
        return $this;
    }
