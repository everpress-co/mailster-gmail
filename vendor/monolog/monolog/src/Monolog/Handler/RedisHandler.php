 ...
 */
class RedisHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, string $key, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \Mailster\Predis\Client || $redis instanceof \Redis)) {
    ...
    {
        return new \Mailster\Monolog\Formatter\LineFormatter();
    }
}
