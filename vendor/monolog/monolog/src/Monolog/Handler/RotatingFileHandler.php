 ...
 */
class RotatingFileHandler extends \Mailster\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \Mailster\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \Mailster\Monolog\Utils::canonicalizePath($filename);
