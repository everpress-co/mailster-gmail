...
use Mailster\Monolog\Formatter\WildfireFormatter;
 ...
 */
class FirePHPHandler extends \Mailster\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \Mailster\Monolog\Formatter\WildfireFormatter();
    }
    /**
