 ...
 */
class FluentdFormatter implements \Mailster\Monolog\Formatter\FormatterInterface
{
    /**
    ...
    public function format(array $record) : string
    {
        ...
        return \Mailster\Monolog\Utils::jsonEncode([$tag, $record['datetime']->getTimestamp(), $message]);
    }
