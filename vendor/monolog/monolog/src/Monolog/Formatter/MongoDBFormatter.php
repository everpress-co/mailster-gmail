 ...
 */
class MongoDBFormatter implements \Mailster\Monolog\Formatter\FormatterInterface
{
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \Mailster\Monolog\Utils::getClass($value);
        return $this->formatArray($objectVars, $nestingLevel);
    }
    protected function formatException(\Throwable $exception, int $nestingLevel)
    {
        $formattedException = ['class' => \Mailster\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
