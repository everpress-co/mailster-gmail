 ...
 */
class IntrospectionProcessor implements \Mailster\Monolog\Processor\ProcessorInterface
{
    private $level;
     ...
     */
    public function __construct($level = \Mailster\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
