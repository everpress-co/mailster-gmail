 ...
 */
class GCECredentials extends \Mailster\Google\Auth\CredentialsLoader implements \Mailster\Google\Auth\SignBlobInterface, \Mailster\Google\Auth\ProjectIdProviderInterface, \Mailster\Google\Auth\GetQuotaProjectInterface
{
    // phpcs:disable
     ...
     */
    public function __construct(\Mailster\Google\Auth\Iam $iam = null, $scope = null, $targetAudience = null, $quotaProject = null)
    {
        $this->iam = $iam;
    ...
    {
        $httpHandler = $httpHandler ?: \Mailster\Google\Auth\HttpHandler\HttpHandlerFactory::build(\Mailster\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        for ($i = 1; $i <= self::MAX_COMPUTE_PING_TRIES; $i++) {
            try {
                ...
                // the metadata resolution was particularly slow. The latter case is
                // "unlikely".
                $resp = $httpHandler(new \Mailster\GuzzleHttp\Psr7\Request('GET', $checkUri, [self::FLAVOR_HEADER => 'Google']), ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]);
                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'Google';
            } catch (\Mailster\GuzzleHttp\Exception\ClientException $e) {
            } catch (\Mailster\GuzzleHttp\Exception\ServerException $e) {
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false)
    {
        ...
        $signer = $this->iam ?: new \Mailster\Google\Auth\Iam($httpHandler);
    ...
    {
        $resp = $httpHandler(new \Mailster\GuzzleHttp\Psr7\Request('GET', $uri, [self::FLAVOR_HEADER => 'Google']));
