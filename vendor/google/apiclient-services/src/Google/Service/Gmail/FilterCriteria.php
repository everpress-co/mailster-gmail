 ...
 * the License.
 */
class Google_Service_Gmail_FilterCriteria extends \Mailster\Google_Model
{
    public $excludeChats;
    public $from;
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_FilterCriteria', 'Google_Service_Gmail_FilterCriteria', \false);
