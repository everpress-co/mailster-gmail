 ...
 * the License.
 */
class Google_Service_Gmail_WatchRequest extends \Mailster\Google_Collection
{
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_WatchRequest', 'Google_Service_Gmail_WatchRequest', \false);
