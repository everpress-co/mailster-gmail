 ...
 * the License.
 */
class Google_Service_Gmail_VacationSettings extends \Mailster\Google_Model
{
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_VacationSettings', 'Google_Service_Gmail_VacationSettings', \false);
