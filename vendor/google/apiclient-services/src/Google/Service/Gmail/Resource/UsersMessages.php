 ...
 *  </code>
 */
class Google_Service_Gmail_Resource_UsersMessages extends \Mailster\Google_Service_Resource
{
    /**
     ...
     */
    public function batchDelete($userId, \Mailster\Google_Service_Gmail_BatchDeleteMessagesRequest $postBody, $optParams = array())
    {
     ...
     * @param array $optParams Optional parameters.
     */
    public function batchModify($userId, \Mailster\Google_Service_Gmail_BatchModifyMessagesRequest $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_Message
     */
    public function import($userId, \Mailster\Google_Service_Gmail_Message $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_Message
     */
    public function insert($userId, \Mailster\Google_Service_Gmail_Message $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_Message
     */
    public function modify($userId, $id, \Mailster\Google_Service_Gmail_ModifyMessageRequest $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Gmail_Message
     */
    public function send($userId, \Mailster\Google_Service_Gmail_Message $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Mailster\\Google_Service_Gmail_Resource_UsersMessages', 'Google_Service_Gmail_Resource_UsersMessages', \false);
