 ...
 *  </code>
 */
class Google_Service_Gmail_Resource_UsersDrafts extends \Mailster\Google_Service_Resource
{
    /**
     ...
     */
    public function create($userId, \Mailster\Google_Service_Gmail_Draft $postBody, $optParams = array())
    {
     ...
     */
    public function send($userId, \Mailster\Google_Service_Gmail_Draft $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_Draft
     */
    public function update($userId, $id, \Mailster\Google_Service_Gmail_Draft $postBody, $optParams = array())
    {
 ...
 *  </code>
 */
\class_alias('Mailster\\Google_Service_Gmail_Resource_UsersDrafts', 'Google_Service_Gmail_Resource_UsersDrafts', \false);
