 ...
 *  </code>
 */
class Google_Service_Gmail_Resource_UsersSettingsSendAs extends \Mailster\Google_Service_Resource
{
    /**
     ...
     */
    public function create($userId, \Mailster\Google_Service_Gmail_SendAs $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Gmail_SendAs
     */
    public function patch($userId, $sendAsEmail, \Mailster\Google_Service_Gmail_SendAs $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Gmail_SendAs
     */
    public function update($userId, $sendAsEmail, \Mailster\Google_Service_Gmail_SendAs $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'sendAsEmail' => $sendAsEmail, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Mailster\\Google_Service_Gmail_Resource_UsersSettingsSendAs', 'Google_Service_Gmail_Resource_UsersSettingsSendAs', \false);
