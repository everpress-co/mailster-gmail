 ...
 *  </code>
 */
class Google_Service_Gmail_Resource_UsersSettings extends \Mailster\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Gmail_AutoForwarding
     */
    public function updateAutoForwarding($userId, \Mailster\Google_Service_Gmail_AutoForwarding $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Gmail_ImapSettings
     */
    public function updateImap($userId, \Mailster\Google_Service_Gmail_ImapSettings $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_LanguageSettings
     */
    public function updateLanguage($userId, \Mailster\Google_Service_Gmail_LanguageSettings $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_PopSettings
     */
    public function updatePop($userId, \Mailster\Google_Service_Gmail_PopSettings $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     * @return Google_Service_Gmail_VacationSettings
     */
    public function updateVacation($userId, \Mailster\Google_Service_Gmail_VacationSettings $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Mailster\\Google_Service_Gmail_Resource_UsersSettings', 'Google_Service_Gmail_Resource_UsersSettings', \false);
