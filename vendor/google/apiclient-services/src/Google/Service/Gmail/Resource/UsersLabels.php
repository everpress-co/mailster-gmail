 ...
 *  </code>
 */
class Google_Service_Gmail_Resource_UsersLabels extends \Mailster\Google_Service_Resource
{
    /**
     ...
     */
    public function create($userId, \Mailster\Google_Service_Gmail_Label $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Gmail_Label
     */
    public function patch($userId, $id, \Mailster\Google_Service_Gmail_Label $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Gmail_Label
     */
    public function update($userId, $id, \Mailster\Google_Service_Gmail_Label $postBody, $optParams = array())
    {
        $params = array('userId' => $userId, 'id' => $id, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Mailster\\Google_Service_Gmail_Resource_UsersLabels', 'Google_Service_Gmail_Resource_UsersLabels', \false);
