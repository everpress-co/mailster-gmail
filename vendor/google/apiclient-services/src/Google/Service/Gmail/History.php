 ...
 * the License.
 */
class Google_Service_Gmail_History extends \Mailster\Google_Collection
{
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_History', 'Google_Service_Gmail_History', \false);
