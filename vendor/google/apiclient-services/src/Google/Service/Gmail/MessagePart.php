 ...
 * the License.
 */
class Google_Service_Gmail_MessagePart extends \Mailster\Google_Collection
{
     ...
     */
    public function setBody(\Mailster\Google_Service_Gmail_MessagePartBody $body)
    {
        $this->body = $body;
    }
    /**
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_MessagePart', 'Google_Service_Gmail_MessagePart', \false);
