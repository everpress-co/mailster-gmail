 ...
 * the License.
 */
class Google_Service_Gmail_SmimeInfo extends \Mailster\Google_Model
{
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_SmimeInfo', 'Google_Service_Gmail_SmimeInfo', \false);
