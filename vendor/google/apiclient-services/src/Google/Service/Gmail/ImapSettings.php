 ...
 * the License.
 */
class Google_Service_Gmail_ImapSettings extends \Mailster\Google_Model
{
    public $autoExpunge;
    public $enabled;
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_ImapSettings', 'Google_Service_Gmail_ImapSettings', \false);
