 ...
 * the License.
 */
class Google_Service_Gmail_SendAs extends \Mailster\Google_Model
{
    public $displayName;
    public $isDefault;
    public $isPrimary;
     ...
     */
    public function setSmtpMsa(\Mailster\Google_Service_Gmail_SmtpMsa $smtpMsa)
    {
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_SendAs', 'Google_Service_Gmail_SendAs', \false);
