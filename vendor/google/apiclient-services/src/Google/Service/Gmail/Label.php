 ...
 * the License.
 */
class Google_Service_Gmail_Label extends \Mailster\Google_Model
{
     ...
     */
    public function setColor(\Mailster\Google_Service_Gmail_LabelColor $color)
    {
        $this->color = $color;
    }
    /**
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_Label', 'Google_Service_Gmail_Label', \false);
