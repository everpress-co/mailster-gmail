 ...
 * the License.
 */
class Google_Service_Gmail_ListSendAsResponse extends \Mailster\Google_Collection
{
 ...
 * the License.
 */
\class_alias('Mailster\\Google_Service_Gmail_ListSendAsResponse', 'Google_Service_Gmail_ListSendAsResponse', \false);
