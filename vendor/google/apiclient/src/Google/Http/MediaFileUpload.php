...
class Google_Http_MediaFileUpload
{
     ...
     */
    public function __construct(\Mailster\Google_Client $client, \Mailster\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = \false)
    {
        $this->client = $client;
    ...
    public function nextChunk($chunk = \false)
    {
        ...
        $request = new \Mailster\GuzzleHttp\Psr7\Request('PUT', $resumeUri, $headers, \Mailster\GuzzleHttp\Psr7\stream_for($chunk));
     ...
     *
     */
    private function makePutRequest(\Mailster\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return \Mailster\Google_Http_REST::decodeHttpResponse($response, $this->request);
    }
    /**
    ...
    public function resume($resumeUri)
    {
        ...
        $httpRequest = new \Mailster\GuzzleHttp\Psr7\Request('PUT', $this->resumeUri, $headers);
    ...
    private function process()
    {
        ...
        $request = $request->withUri(\Mailster\GuzzleHttp\Psr7\Uri::withQueryValue($request->getUri(), 'uploadType', $uploadType));
        ...
        $request = $request->withBody(\Mailster\GuzzleHttp\Psr7\stream_for($postBody));
    ...
    private function fetchResumeUri()
    {
        ...
        throw new \Mailster\Google_Exception($error);
    }
    private function transformToUploadUrl()
    {
        ...
        $uri = \Mailster\GuzzleHttp\Psr7\Uri::fromParts($parts);
 ...
 * of sizable data.
 */
\class_alias('Mailster\\Google_Http_MediaFileUpload', 'Google_Http_MediaFileUpload', \false);
