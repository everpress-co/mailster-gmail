...
if (!\class_exists('Mailster\\Google_Client')) {
 ...
 */
class Google_Collection extends \Mailster\Google_Model implements \Iterator, \Countable
{
 ...
 * iterate over the object rather than a reference inside.
 */
\class_alias('Mailster\\Google_Collection', 'Google_Collection', \false);
