...
class Google_Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \Mailster\Google_Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \Mailster\Google_Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
 ...
 *
 */
\class_alias('Mailster\\Google_Model', 'Google_Model', \false);
