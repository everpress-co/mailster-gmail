 ...
 */
namespace Mailster\phpseclib\System\SSH;

use Mailster\phpseclib\Crypt\RSA;
use Mailster\phpseclib\System\SSH\Agent\Identity;
/**
...
class Agent
{
    ...
    function requestIdentities()
    {
        ...
        for ($i = 0; $i < $keyCount; $i++) {
            ...
            if (isset($key)) {
                $identity = new \Mailster\phpseclib\System\SSH\Agent\Identity($this->fsock);
